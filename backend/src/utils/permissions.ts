...
export const getRolePermissionsByCategory = (role: UserRole): Record<PermissionCategory, PermissionInfo[]> => {
  const rolePermissions = getRolePermissions(role);
  const result: Record<PermissionCategory, PermissionInfo[]> = {} as Record<PermissionCategory, PermissionInfo[]>;
